...
if __name__ == '__main__':
  ...
  parser.add_option('-e', '--extensions-include-path', help='''if supplied,
overrides the default path chrome/browser/extensions to be used in
generated_api.cc''')
