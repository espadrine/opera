...
void SetMemoryCollarFunction(MemoryCollarFunction f) {
  thunks::SetMemoryCollarFunctionFunction set_memory_collar_function_function =
      thunks::GetSetMemoryCollarFunctionFunction();
  if (set_memory_collar_function_function)
    set_memory_collar_function_function(f);
}
...
void SetSetMemoryCollarFunctionFunction(
  ...
  DCHECK_EQ(thunks::GetSetMemoryCollarFunctionFunction(),
            reinterpret_cast<thunks::SetMemoryCollarFunctionFunction>(NULL));
  thunks::SetSetMemoryCollarFunctionFunction(
      set_memory_collar_function_function);
}
