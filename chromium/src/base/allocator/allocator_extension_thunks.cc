...
static SetMemoryCollarFunctionFunction
    g_set_memory_collar_function_function = NULL;
...
void SetSetMemoryCollarFunctionFunction(
  ...
  g_set_memory_collar_function_function = set_memory_collar_function_function;
}

SetMemoryCollarFunctionFunction GetSetMemoryCollarFunctionFunction() {
  return g_set_memory_collar_function_function;
}
