...
static void DefaultMemoryAllowanceCB() {
}
...
MessageLoop::MessageLoop(Type type)
    : type_(type),
      ...
      memory_allowance_cb_(DefaultMemoryAllowanceCB) {
...
#define MESSAGE_PUMP_UI new MessagePumpDefault();
#define MESSAGE_PUMP_IO new MessagePumpLibevent()
...
void MessageLoop::MemoryAllowanceWakeUp() {
  pump_->ScheduleWork();
}

void MessageLoop::SetMemoryAllowanceCB(MemoryAllowanceCB cb) {
  memory_allowance_cb_ = cb;
}
