...
class BASE_EXPORT Value {
 public:
  ...
  static FundamentalValue* CreateInt64Value(int64 in_value);
  ...
  virtual bool GetAsPickle(PickleValue** out_value);
  virtual bool GetAsPickle(const PickleValue** out_value) const;
...
class BASE_EXPORT DictionaryValue : public Value {
 public:
  ...
  void SetInt64(const std::string& path, int64 in_value);
  ...
  void SetInt64WithoutPathExpansion(const std::string& path, int64 in_value);
  ...
  bool GetPickle(const std::string& path, const PickleValue** out_value) const;
  bool GetPickle(const std::string& path, PickleValue** out_value);
  ...
  bool GetIntegerWithoutPathExpansion(const std::string& key,
                                      int* out_value) const;
  bool GetInt64WithoutPathExpansion(const std::string& key,
  ...
  bool GetListWithoutPathExpansion(const std::string& key,
                                   ListValue** out_value);
  bool GetPickleWithoutPathExpansion(const std::string& key,
...
class BASE_EXPORT ListValue : public Value {
 public:
  ...
  void AppendInt64(int64 in_value);
...
class BASE_EXPORT PickleValue : public Value {
 public:
  PickleValue();
  virtual ~PickleValue();

  // Creates the PickleValue from a copy of |data|.
  static PickleValue* CreateWithCopiedBuffer(const char* data, int data_len);
  Pickle& GetPickle() { return pickle_; }

  // Overridden from Value:
  virtual bool GetAsPickle(PickleValue** out_value) OVERRIDE;
  virtual bool GetAsPickle(const PickleValue** out_value) const OVERRIDE;
  virtual Value* DeepCopy() const OVERRIDE;

 private:
  PickleValue(const char* data, int data_len);
  Pickle pickle_;
  scoped_ptr<const char[]> copied_pickle_data_;

  DISALLOW_COPY_AND_ASSIGN(PickleValue);
};
