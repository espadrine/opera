  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        # With SkImageDecorer/SkImageEncoder being an exported API, we need to
        # have dummy implementation compiled to avoid linking problems.
        ...
        'ext/bitmap_platform_device_embedded.cc',
        'ext/bitmap_platform_device_embedded.h',
...
#            'SK_USE_COLOR_LUMINANCE',
        ...
        [ 'use_glib == 0 and OS != "android" and linux_embedded == 0', {
        ...
        [ 'linux_embedded == 1', {
          # Most of the configuration is inspired by the Android section below.
          'dependencies': [
            # Might want to change this to static freetype like Android.
            '../build/linux/system.gyp:freetype2',
          ],
          'dependencies!': [
	    # embedded linux doesn't use Skia's PDF generation, which is
	    # what uses sfntly.
          ...
          'conditions': [
            [ '_toolset == "target"', {
              ...
              'sources': [
                ...
                '../third_party/skia/src/images/SkImageEncoder.cpp',
                '../third_party/skia/src/images/SkImageEncoder_Factory.cpp',
                '../third_party/skia/src/images/SkJpegUtility.cpp',
              ],
              'sources/': [
...
#           'SK_USE_COLOR_LUMINANCE',
        ...
        ['webkit_component=="shared_library"', {
          'defines': [
            'WEBKIT_COMPONENT_BUILD',
          ]
        }],
        ['component=="shared_library" or webkit_component=="shared_library"', {
          'defines': [
            'GR_DLL=1',
            'GR_IMPLEMENTATION=1',
            'SKIA_DLL',
