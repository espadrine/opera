...
class MediaPlayerManagerExternal;
#endif
...
class CONTENT_EXPORT RenderViewHostImpl
 ...
 public:
  ...
  virtual void RequestBitmap(
      const gfx::Size& size, bool wait_for_frame,
      base::Callback<void(const SkBitmap&)> callback) OVERRIDE;
  ...
  void RequestBitmapResult(int32 request_id, const SkBitmap& bitmap);
 ...
 protected:
  ...
  void OnMediaNotification(int64 player_cookie,
                           ...
                           bool has_audio,
                           bool is_playing);
  void OnUpdatePlayState(WebKit::WebMediaPlayState play_state);
 ...
 private:
  ...
  int32 next_bitmap_request_id_;
  std::map<int32, base::Callback<void(const SkBitmap& bitmap)> > bitmap_requests_;
...
#endif
#if defined(OPERA_TVSDK) && defined(ENABLE_UVA)
  MediaPlayerManagerExternal* media_player_manager_;
#endif
