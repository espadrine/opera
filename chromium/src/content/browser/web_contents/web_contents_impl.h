...
class CONTENT_EXPORT WebContentsImpl
 ...
 public:
  ...
  virtual void SearchUsingText(const string16& text) OVERRIDE;
  ...
  virtual void UpdatePlayState(WebKit::WebMediaPlayState play_state) OVERRIDE;
 ...
 private:
  ...
  void OnRegisterProtocolHandler(const std::string& protocol,
                                 ...
                                 const string16& title,
                                 bool user_gesture);
  void OnSampledScrollSpeed(gfx::Point delta,
