...
struct GpuHostMsg_RequestBitmapResult_Params;
...
class GpuProcessHostUIShim : public IPC::Listener,
 ...
 private:
  ...
  void OnAcceleratedWidgetAcquire(int32 route_id, int32 surface_id);
  void OnAcceleratedWidgetRelease(int32 surface_id);
  void OnAcceleratedWidgetBuffersSwapped(
  ...
  void OnRequestBitmapResult(
      const GpuHostMsg_RequestBitmapResult_Params& params);
  void OnScheduleComposite(int32 surface_id);
  void OnFrameDrawn(const ui::LatencyInfo& latency_info);

  void AcceleratedWidgetAcquireResultCallback(int32 route_id,
                                              int32 surface_id);
  void AcceleratedWidgetReleaseCallback(int32 route_id);
