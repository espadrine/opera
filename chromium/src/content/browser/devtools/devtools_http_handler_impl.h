...
class DevToolsHttpHandlerImpl
 ...
 private:
  ...
  virtual void AddIgnoreScheme(const std::string& scheme) OVERRIDE;
  virtual void RemoveIgnoreScheme(const std::string& scheme) OVERRIDE;
  ...
  bool IsFilteredScheme(RenderViewHost* rvh);

  // The thread used by the devtools handler to run server socket.
  scoped_ptr<base::Thread> thread_;

  // Should probably be some global constant loaded.
  std::set<std::string> ignore_schemes_;
