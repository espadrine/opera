...
class ContentViewCoreImpl : public ContentViewCore,
 ...
 public:
  ...
  virtual jboolean DrawCompositorContent(jobject bitmap) OVERRIDE;
  ...
  void SwapSelectionAnchorAndFocus(JNIEnv* env, jobject obj);
  void MoveSelectionFocus(JNIEnv* env, jobject obj, jint x, jint y);
  ...
  void Find(JNIEnv* env, jobject obj, jint request_id, jstring search_string,
            jboolean forward, jboolean match_case, jboolean find_next);

  void StopFinding(JNIEnv* env, jobject obj, jint find_action);

  void ActivateNearestFindResult(JNIEnv* env, jobject obj,
                                 jint request_id, jfloat x, jfloat y);
  ...
  void SuspendMedia(JNIEnv* env, jobject obj);
  void ResumeSuspendedMedia(JNIEnv* env, jobject obj);
  ...
  void SearchUsingText(JNIEnv* env, jobject obj, jstring text);
  jboolean OnAnimate(JNIEnv* env, jobject /* obj */, jlong frame_time_micros);
  jboolean PopulateBitmapFromCompositor(JNIEnv* env,
                                        jobject obj,
                                        jobject jbitmap);
  void NotifyContextMenuClosed(JNIEnv* env, jobject obj);
  void WasResized(JNIEnv* env, jobject obj);
  jboolean UsingBrowserSideCompositor(JNIEnv* env, jobject obj);
  ...
  void UpdateTopControlsState(JNIEnv* env,
                              ...
                              bool only_at_top,
                              bool animate);
  jboolean IsTopBarAnimating(JNIEnv* env, jobject obj);
  ...
  void ClearFocusedNode(JNIEnv* env, jobject obj);

  jboolean IsShowingInterstitialPage(JNIEnv* env, jobject obj);

  void ScrollToVerticalEdge(JNIEnv* env, jobject obj, jboolean scroll_to_top);
  ...
  void ForceRenderWidgetHostViewBackingSize(JNIEnv* env,
                                            jobject obj,
                                            int width,
                                            int height);
 ...
 private:
  ...
  // Ignore some events when the top bar is animating.
  bool top_bar_is_animating_;
