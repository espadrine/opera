...
public class ChildProcessService extends Service {
    ...
    private ArrayList<FDParcelable> mFileFds;
    ...
    private final IChildProcessService.Stub mBinder = new IChildProcessService.Stub() {
        ...
        public int setupConnection(Bundle args, IChildProcessCallback callback) {
            ...
            // FIXME Separate necessary functions from content view library into its own that
            //       should be loaded unconditionally. Now it's assumed that the content shell
            //       library will always be loaded.
            LibraryLoader.syncLibraryLoaded();
            // Without this args.getParcelable(...) won't be able to find FDParcelable.
            args.setClassLoader(FDParcelable.class.getClassLoader());
    ...
    private void establishSurfaceTexturePeer(
        ...
        if (android.os.Build.VERSION.SDK_INT >=
            ...
            ICSCompatLayer.establishSurfaceTexturePeer(
                    mCallback, pid, surfaceObject, primaryID, secondaryID);
        } else {
            GenericCompatLayer.establishSurfaceTexturePeer(
                    mCallback, pid, surfaceObject, primaryID, secondaryID);
        }
    }
    ...
    private static class GenericCompatLayer {
        private static final String TAG = ChildProcessService.TAG + ".GenericCompatLayer";

        static void establishSurfaceTexturePeer(
            ...
            try {
                callback.establishSurfacePeer(pid, surface, primaryID, secondaryID);
            } catch (RemoteException e) {
                Log.e(TAG, "Unable to call establishSurfaceTexturePeer: " + e);
                return;
            }
    ...
    private static class ICSCompatLayer {
        private static final String TAG = ChildProcessService.TAG + ".ICSCompatLayer";
