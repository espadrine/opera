...
public abstract class InsertionHandleController implements CursorController {
    ...
    /**
     * @return Pixel width of insertion handle.
     */
    public int getHandleWidth() {
        return mHandle.getDrawable().getIntrinsicWidth();
    }

    /**
     * @return Pixel height of insertion handle.
     */
    public int getHandleHeight() {
        return mHandle.getDrawable().getIntrinsicHeight();
    }
    ...
    boolean canPaste() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return HoneyCombCompatLayer.canPaste(mContext);
        } else {
            return GenericCompatLayer.canPaste(mContext);
        }
    }
    ...
    public void setWindowPadding(int padding) {
        if (mHandle != null) mHandle.setWindowPadding(padding);
    }
    ...
    private static class GenericCompatLayer {
        static boolean canPaste(Context context) {
            return false;
        }
    }
