...
public class ContentViewRenderView extends FrameLayout {
    ...
    public ContentViewRenderView(Context context) {
        ...
        // Force usage of RGBA888 to align with the kConfigAttribs used in eglChooseConfig.
        // See GLSurfaceEGL::InitializeOneOff (in gl_surface_egl.cc).
    ...
    public void setVisibility(int visibility) {
        // When someone wants to hide/show this view, they won't necessarily
        // know that it contains a SurfaceView. If the application contains
        // other surface views those views will still be obscured by our
        // surface view after hiding us, unless we make sure to sync the
        // visibility of the surface view with our own visibility.
