...
IPC_ENUM_TRAITS(webkit_glue::TextLayoutStrategy)
...
IPC_STRUCT_TRAITS_BEGIN(WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(default_text_color)
  ...
  IPC_STRUCT_TRAITS_MEMBER(media_blocking_enabled)
  IPC_STRUCT_TRAITS_MEMBER(spatial_navigation_enabled)
  IPC_STRUCT_TRAITS_MEMBER(text_layout_strategy)
