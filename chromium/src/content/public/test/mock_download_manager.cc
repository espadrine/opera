...
DownloadItem* MockDownloadManager::CreateDownloadItem(
  ...
  CreateDownloadItemAdapter adapter(
      current_path, target_path, url_chain, referrer_url, mime_type,
      original_mime_type, start_time, end_time, received_bytes, total_bytes,
      state, danger_type, interrupt_reason, opened);
