...
class CONTENT_EXPORT ContentMainDelegate {
 public:
  ...
  // Informs the embedder that the memory allowance system is about to
  // be setup. At this point the embedder can override the default
  // implementations of the MemoryAllowanceController and the
  // MemoryAllowanceAgent by calling SetInstance() on the respective
  // classes.
  // The default is to leave the memory allowance system disabled.
  virtual void MemoryAllowanceSetup() {}
