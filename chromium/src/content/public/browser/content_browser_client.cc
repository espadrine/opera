...
#if defined(OPERA_TVSTORE)
void ContentBrowserClient::OnLoadTVApp(
    const ViewHostMsg_LoadTVApp_Params& params) {
  NOTREACHED(); // overridden in tvsdk/impl/shell_content_browser_client.cc
}
#endif
