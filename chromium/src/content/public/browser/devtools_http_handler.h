...
class DevToolsHttpHandler {
 public:
  ...
  // Set a URL scheme which the dev tool should ignore.
  virtual void AddIgnoreScheme(const std::string& scheme) = 0;

  // Remove a URL scheme which the dev tool should not ignore.
  virtual void RemoveIgnoreScheme(const std::string& scheme) = 0;
