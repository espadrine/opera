...
class CONTENT_EXPORT RenderWidgetHostViewPort : public RenderWidgetHostView,
 ...
 public:
  ...
  virtual void CompositorBuffersPresented() {}
  virtual void RequestFrameCallback(base::Callback<void()> callback) {}
  ...
  // Called only when browser side compositor is disabled.
  virtual void FrameScheduled() = 0;
  virtual void SyncBufferSize(const gfx::Size& size) = 0;
