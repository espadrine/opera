...

{
  ...
  'sources': [
    ...
    'public/common/memory_allowance_agent.cc',
    'public/common/memory_allowance_agent.h',
    ...
    'common/bitmap_pool.cc',
    'common/bitmap_pool.h',
    ...
    'common/gpu/gpu_surface_tracker.cc',
    'common/gpu/gpu_surface_tracker.h',
    ...
    'common/gpu/shared_widget_transport_surface.cc',
    'common/gpu/shared_widget_transport_surface.h',
    'common/gpu/swap_and_swizzle.c',
    'common/gpu/swap_and_swizzle.h',
    ...
    'common/memory_allowance_agent_impl.cc',
    'common/memory_allowance_agent_impl.h',
  ...
  'conditions': [
    ...
    ['target_arch=="arm" and arm_version>=6', {
      'sources': [
        'common/gpu/swap_and_swizzle_armv6.S',
      ],
      'sources!': [
        'common/gpu/swap_and_swizzle.c',
      ],
