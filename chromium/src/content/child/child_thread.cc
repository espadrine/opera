...
using content::MemoryAllowanceAgent;
...
void ChildThread::Init() {
  ...
  channel_->AddFilter(new tracing::ChildTraceMessageFilter(
      ChildProcess::current()->io_message_loop_proxy()));
  IPC::ChannelProxy::MessageFilter* mf =
      MemoryAllowanceAgent::GetInstance()->message_filter();
  if (mf)
    channel_->AddFilter(mf);
