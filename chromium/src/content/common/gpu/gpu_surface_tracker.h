...
#ifndef CONTENT_COMMON_GPU_GPU_SURFACE_TRACKER_H_
#define CONTENT_COMMON_GPU_GPU_SURFACE_TRACKER_H_
...
class GpuSurfaceTracker : public GpuSurfaceLookup {
 public:
  ...
  // On Android, ANativeWindow_release() must be called to release the result.
  ...
  // Returns the native widget associated with a given surface_id,
  // or kNullAcceleratedWidget if surface_id has no associated widget.
...
#endif  // CONTENT_COMMON_GPU_GPU_SURFACE_TRACKER_H_
