...
bool GpuCommandBufferStub::OnMessageReceived(const IPC::Message& message) {
  ...
  IPC_BEGIN_MESSAGE_MAP(GpuCommandBufferStub, message)
    ...
    IPC_MESSAGE_HANDLER(GpuCommandBufferMsg_ActivateOutputSurface,
                        OnActivateOutputSurface)
    ...
    IPC_MESSAGE_HANDLER(GpuCommandBufferMsg_RequestBitmap,
                        OnRequestBitmap);
...
void GpuCommandBufferStub::OnActivateOutputSurface() {
  TRACE_EVENT0("gpu", "GpuCommandBufferStub::OnActivateOutputSurface");
  surface_->Activate();
}
...
void GpuCommandBufferStub::OnRequestBitmap(int32 request_id,
                                           const gfx::Size& size,
                                           bool wait_for_frame) {
  if (!bitmap_request_handler_.is_null())
    bitmap_request_handler_.Run(request_id, size, wait_for_frame);
}
...
void GpuCommandBufferStub::SetBitmapRequestHandler(
    base::Callback<void(int32, const gfx::Size&, bool)> callback) {
  bitmap_request_handler_ = callback;
}
