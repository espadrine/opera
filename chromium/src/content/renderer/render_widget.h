...
class CONTENT_EXPORT RenderWidget
 ...
 protected:
  ...
  virtual double GetSecondsPerFrameCap() const;
  virtual bool HasSecondsPerFrameCap() const;
  ...
  // |bounds_rect| content should be rendered in. |transport_dib|
  // transportable preview bitmap. On success the function returns the size
  // of the rendered bitmap and updates the |transport_dib| pointer. On
  // failure the function returns an empty size and sets the |transport_dib|
  // pointer to NULL.
  ...
  bool pending_update_selection_bounds_;
  bool is_animating_top_bar_;

#if defined(OS_ANDROID)
  // Selection preview bitmap which is currently being processed.
  TransportDIB* current_selection_preview_dib_;
