...
void RenderThreadImpl::Shutdown() {
  ...
  if (compositor_filter_.get()) {
    RemoveFilter(compositor_filter_.get());
    compositor_filter_ = NULL;
  }
...
void RenderThreadImpl::EnsureWebKitInitialized() {
  ...
  if (enable) {
    ...
    compositor_filter_ =
        RenderWidgetCompositor::CreateFilter(compositor_message_loop_proxy_);
    AddFilter(compositor_filter_);
  }
