...

{
  ...
  'sources': [
    ...
    'public/browser/memory_allowance_controller.cc',
    'public/browser/memory_allowance_controller.h',
    ...
    'browser/android/native_fd_parcelable.cc',
    'browser/android/native_fd_parcelable.h',
    ...
    'browser/gpu/accelerated_widget_manager.cc',
    'browser/gpu/accelerated_widget_manager.h',
    ...
    'browser/memory_allowance_controller_impl.cc',
    'browser/memory_allowance_controller_impl.h',
  ...
  'conditions': [
    ...
    ['use_aura!=1 and OS!="win" and opera_tvsdk!=1', {
      'sources!': [
        'browser/renderer_host/ui_events_helper.cc',
        'browser/renderer_host/ui_events_helper.h',
        'browser/renderer_host/tap_suppression_controller.cc',
    ...
    ['enable_jsplugins==1', {
      'sources': [
        'browser/browser_process_jsplugins_sub_thread.cc',
        'browser/browser_process_jsplugins_sub_thread.h',
        ],
    }],
    ['input_speech==0', {
      'sources/': [
