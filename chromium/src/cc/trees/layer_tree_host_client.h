...
class LayerTreeHostClient {
 public:
  ...
  virtual void ApplyScrollAndScale(gfx::Vector2d scroll_delta,
                                   float page_scale) = 0;
  virtual void DidCompleteScale() = 0;
  virtual void DidPinchGesture(float scale, const gfx::Point&) = 0;
  virtual void MaxScrollUpdated(const gfx::Vector2d& maxScroll) = 0;
  ...
  virtual void DidChangeTopControlsAnimationState(bool active) {}
