...
void SingleThreadProxy::ResizeStarted() {
  NOTIMPLEMENTED();
}

void SingleThreadProxy::ScheduleFrame() {
  NOTIMPLEMENTED();
}

void SingleThreadProxy::ForceFrameOnImplThread() {
  NOTIMPLEMENTED();
}

void SingleThreadProxy::ScheduleFrameOnImplThread() {
  NOTIMPLEMENTED();
}
...
void SingleThreadProxy::NonEmptyTreeActivated() {
  layer_tree_host_->NonEmptyTreeActivated();
}
...
void SingleThreadProxy::DidChangeTopControlsAnimationState(bool active) {
...
base::TimeTicks SingleThreadProxy::GetAnimationMonotonicTime()
{
...
void SingleThreadProxy::DidPinchGesture(float scale, const gfx::Point& anchor)
{
    layer_tree_host_->DidPinchGesture(scale, anchor);
}

void SingleThreadProxy::MaxScrollUpdated(const gfx::Vector2d& max_scroll)
{
  layer_tree_host_->MaxScrollUpdated(max_scroll);
}

void SingleThreadProxy::PendingTreeActivated(const gfx::Vector2d& scrollTotal)
{
  layer_tree_host_->PendingTreeActivated(scrollTotal);
}
