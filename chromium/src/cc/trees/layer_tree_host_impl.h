...
class LayerTreeHostImplClient {
 public:
  ...
  virtual void NonEmptyTreeActivated() = 0;
  ...
  virtual void DidPinchGesture(float scale, const gfx::Point&) = 0;
  virtual void MaxScrollUpdated(const gfx::Vector2d& max_scroll) = 0;
  virtual void PendingTreeActivated(const gfx::Vector2d& scrollTotal) = 0;
  virtual void RenewTreePriority() = 0;
  virtual base::TimeTicks GetAnimationMonotonicTime() = 0;
  virtual void RequestScrollbarAnimationOnImplThread(base::TimeDelta delay) = 0;
  virtual void InvalidateOnImplThread() {}
  virtual void StartFrameLoopOnImplThread() {}
  virtual void StopFrameLoopOnImplThread() {}
  virtual void DidActivatePendingTree() = 0;
  virtual void DidChangeTopControlsAnimationState(bool active) = 0;
...
class CC_EXPORT LayerTreeHostImpl
 ...
 public:
  ...
  virtual base::TimeTicks GetAnimationMonotonicTime() OVERRIDE;
 ...
 public:
  ...
  void MaxScrollUpdated(const gfx::Vector2d& max_scroll);
 ...
 private:
  ...
  void UpdateFrameLoopMask(uint32 mask);
  ...
  bool visible_;
  bool first_nonempty_tree_activated_;
  ...
  enum FrameLoopMask {
    FRAME_LOOP_SCROLL = (1 << 0),
    FRAME_LOOP_PINCH = (1 << 1)
  };

  uint32 frame_loop_mask_;
