...
class ThreadProxy : public Proxy,
 ...
 public:
  ...
  virtual void ResizeStarted() OVERRIDE;
  virtual void ScheduleFrame() OVERRIDE;
  virtual void ForceFrameOnImplThread() OVERRIDE;
  virtual void ScheduleFrameOnImplThread() OVERRIDE;
  ...
  virtual void MaxScrollUpdated(const gfx::Vector2d& max_scroll) OVERRIDE;
