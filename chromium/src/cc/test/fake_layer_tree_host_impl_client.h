...
class FakeLayerTreeHostImplClient : public LayerTreeHostImplClient {
 public:
  ...
  virtual base::TimeTicks GetAnimationMonotonicTime() OVERRIDE { return base::TimeTicks(); }
  ...
  virtual void PendingTreeActivated(const gfx::Vector2d& scroll_total) OVERRIDE {}
