...
void WebLayerTreeViewImplForTesting::DidCompleteScale() {
}

void WebLayerTreeViewImplForTesting::DidPinchGesture(float scale, const gfx::Point&) {
}

void WebLayerTreeViewImplForTesting::MaxScrollUpdated(const gfx::Vector2d& maxScroll) {
}

void WebLayerTreeViewImplForTesting::PendingTreeActivated(const gfx::Vector2d& scrollTotal) {
}
