...
const DataResource kDataResources[] = {
  ...
  { "mediaplayerDownload",
    IDR_MEDIAPLAYER_DOWNLOAD_BUTTON, ui::SCALE_FACTOR_100P },
  { "mediaplayerDownloadHover",
    IDR_MEDIAPLAYER_DOWNLOAD_BUTTON_HOVER, ui::SCALE_FACTOR_100P },
  { "mediaplayerDownloadDown",
    IDR_MEDIAPLAYER_DOWNLOAD_BUTTON_DOWN, ui::SCALE_FACTOR_100P },
  { "mediaplayerDownloadDisabled",
    IDR_MEDIAPLAYER_DOWNLOAD_BUTTON_DISABLED, ui::SCALE_FACTOR_100P },
