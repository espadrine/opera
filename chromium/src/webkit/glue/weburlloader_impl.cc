...
void WebURLLoaderImpl::Context::Start(
  ...
  WebURLRequest::TargetType target_type = request.targetType();
  if (target_type == WebURLRequest::TargetIsObject ||
      target_type == WebURLRequest::TargetIsMedia)
    load_flags |= net::LOAD_BYPASS_TURBO;
