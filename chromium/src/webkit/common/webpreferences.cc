...
WebPreferences::WebPreferences()
    : default_font_size(16),
      ...
      cookie_enabled(true),
      text_layout_strategy(webkit_glue::TEXT_LAYOUT_NORMAL)
...
COMPILE_ASSERT_MATCHING_ENUMS(
    webkit_glue::TEXT_LAYOUT_NORMAL, WebSettings::TextLayoutNormal);
COMPILE_ASSERT_MATCHING_ENUMS(
    webkit_glue::TEXT_LAYOUT_AUTOSIZING, WebSettings::TextLayoutAutosizing);
COMPILE_ASSERT_MATCHING_ENUMS(
    webkit_glue::TEXT_LAYOUT_WRAPPING, WebSettings::TextLayoutWrapping);
