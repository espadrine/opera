...
class NET_EXPORT CertVerifier {
 public:
  ...
  // Set a factory to override CreateDefault().
  // The caller of this function keeps the ownership of |factory| object.
  static void SetFactory(CertVerifierFactory* factory);
