...
# since gyp_chromium is automatically forcing its inclusion.
{
  ...
  'variables': {
    ...
    'variables': {
      'variables': {
        'variables': {
          ...
          # Whether to build for a linux embedded system with few desktop like
          # dependencies, ie no window manager or native windows.
          'linux_embedded%': 0,

          # Whether to use fontconfig for font handling or not.
          'use_fontconfig%': 1,
          ...
          # Blink/WebKit tests are enabled by default.
          'enable_blink_tests%': 1,

          # Enable HiDPI support.
          'enable_hidpi%': 0,

          # What proxies to use for Turbo.
          'turbo_proxy_host%': 'soyuz-turbo.opera-mini.net',
          'turbo_proxy_port%': '80',
        ...
        'chromeos%': '<(chromeos)',
        'use_aura%': '<(use_aura)',
        'turbo_proxy_host%': '<(turbo_proxy_host)',
        'turbo_proxy_port%': '<(turbo_proxy_port)',
        'use_ash%': '<(use_ash)',
        'use_ozone%': '<(use_ozone)',
        ...
        'enable_blink_tests%': '<(enable_blink_tests)',
        ...
        # Disable <input type="color"> for products that don't implement the UI.
        'disable_input_type_color%': 0,
        ...
        'conditions': [
          ...
          ['(OS=="linux" or OS=="freebsd" or OS=="openbsd" or OS=="solaris") and use_aura==0 and use_ozone==0 and linux_embedded==0', {
            'toolkit_uses_gtk%': 1,
          }, {
            'toolkit_uses_gtk%': 0,
          }],
      ...
      'disable_input_type_color%': '<(disable_input_type_color)',
      'buildtype%': '<(buildtype)',
      'branding%': '<(branding)',
      ...
      # Variable 'webkit_component' is for cases where we would like to build the
      # webkit component as a dynamic shared library while using static libraries
      # for the other components (though v8 and skia will also be dynamic libs).
      # By default, webkit_component is set to whatever component is set to and
      # it can be overriden by the GYP command line or by ~/.gyp/include.gypi.
      #'webkit_component%': 'static_library',
      ...
      # Build Opera's set of extensions APIs
      'opera_extensions%': 0,
      ...
      # The prefix for common resources packs (e.g. 'chrome').
      'common_resources_prefix%': 'chrome',
      ...
      'conditions': [
        ...
        ['OS=="win" or OS=="mac" or OS=="ios" or OS=="android" or use_ozone==1 or linux_embedded==1', {
          'use_x11%': 0,
        }, {
          'use_x11%': 1,
        }],
        ...
        ['OS=="win" or OS=="mac" or OS=="ios" or OS=="android" or linux_embedded==1', {
          'use_glib%': 0,
          'use_pango%': 0,
        }, {
          'use_glib%': 1,
        ...
        # compositor.
        ['OS!="mac" and OS!="android" and linux_embedded!=1', {
          'use_canvas_skia%': 1,
        }],
    ...
    'opera_extensions%': '<(opera_extensions)',
    'enable_plugin_installation%': '<(enable_plugin_installation)',
    'enable_plugins%': '<(enable_plugins)',
    'enable_jsplugins%': '<(enable_jsplugins)',
    ...
    # Build Opera's Views framework instead of Chromium's one
    'opera_views_build%': 0,

    # Code signing for iOS binaries.  The bots need to be able to disable this.
    'chromium_ios_signing%': 1,

    # Whether or not Opera TV Store is enabled (depends on opera_tvsdk==1).
    'opera_tvstore%': 0,
    ...
    # Enable or disable Torrent support
    'enable_torrent%': 0,
    ...
    # The URL scheme to use for WebUI code (e.g. 'chrome').
    'web_ui_scheme%': 'chrome',

    # The prefix for common resources packs (e.g. 'chrome').
    'common_resources_prefix%': '<(common_resources_prefix)',
    ...
    # Whether it is an Opera TVSDK build or not.
    'opera_tvsdk%': 0,

    # Whether the Opera TVSDK build is using UVA or not.
    # This is a TVSDK specific flag that should only be used
    # together with opera_tvsdk=1
    'enable_uva%': 0,

    # The architecture to generate code for if target_arch=ia32.
    'ia32_arch%': '',
    ...
    'conditions': [
      ...
      ['OS=="android"', {
        # Override some components to limit the number of .so files.
        'component_override%': 'static_library',
      }, {
      ...
      ['common_resources_prefix=="opera"', {
        'grit_defines': ['-D', 'use_opera_desktop_translations'],
      }],
      ['OS=="android"', {
      ...
      ['opera_extensions==1', {
        'grit_defines': ['-D', 'opera_extensions'],
      }],
      ['enable_printing==1', {
  ...
  'target_defaults': {
    ...
    'conditions': [
      ...
      ['linux_embedded==1', {
        'defines': ['LINUX_EMBEDDED'],
      }],
      ['use_fontconfig==1', {
        'defines': ['USE_FONTCONFIG'],
      }],
      ['branding=="Chrome"', {
          ...
          ['target_arch=="ia32"', {
            'target_conditions': [
              ['_toolset=="target"', {
                ...
                'conditions': [
                  ['branding=="Chromium" and disable_sse2==0 and ia32_arch==""', {
                    'cflags': [
                      '-march=pentium4',
                      '-msse2',
                      '-mfpmath=sse',
