...
/**
 * Fallback enumeration of system fonts where /system/etc/system_fonts.xml
 * and /system/etc/fallback_fonts.xml are missing. Needed to be compatible
 * with Android versions < 4.0.
 */
static void getSystemFallbackFontFamilies(SkTDArray<FontFamily*> &fontFamilies) {
    FontFamily *family;

    family = new FontFamily();
    family->order = -1;
    *family->fNames.append() = "serif";
    *family->fNames.append() = "times";
    *family->fNames.append() = "times new roman";
    *family->fNames.append() = "palatino";
    *family->fNames.append() = "georgia";
    *family->fNames.append() = "baskerville";
    *family->fNames.append() = "goudy";
    *family->fNames.append() = "fantasy";
    *family->fNames.append() = "cursive";
    *family->fFontFiles.append() = new FontFileInfo("DroidSerif-Regular.ttf");
    *family->fFontFiles.append() = new FontFileInfo("DroidSerif-Bold.ttf");
    *family->fFontFiles.append() = new FontFileInfo("DroidSerif-Italic.ttf");
    *family->fFontFiles.append() = new FontFileInfo("DroidSerif-BoldItalic.ttf");
    *fontFamilies.append() = family;

    family = new FontFamily();
    family->order = -1;
    *family->fNames.append() = "Droid Sans";
    *family->fFontFiles.append() = new FontFileInfo("DroidSans.ttf");
    *family->fFontFiles.append() = new FontFileInfo("DroidSans-Bold.ttf");
    *fontFamilies.append() = family;

    family = new FontFamily();
    family->order = -1;
    *family->fNames.append() = "monospace";
    *family->fNames.append() = "courier";
    *family->fNames.append() = "courier new";
    *family->fNames.append() = "monaco";
    *family->fFontFiles.append() = new FontFileInfo("DroidSansMono.ttf");
    *fontFamilies.append() = family;

    family = new FontFamily();
    family->order = -1;
    family->fIsFallbackFont = true;
    *family->fFontFiles.append() = new FontFileInfo("DroidSansFallback.ttf");
    *fontFamilies.append() = family;
}
...
static SkFontConfigInterfaceAndroid* getSingletonInterface() {
    ...
    if (NULL == gFontConfigInterface) {
        ...
        // If no fonts have been found, add the system fallback Droid fonts.
        if (fontFamilies.count() == 0) {
            getSystemFallbackFontFamilies(fontFamilies);
        }
