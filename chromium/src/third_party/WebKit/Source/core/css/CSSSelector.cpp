...
static HashMap<AtomicStringImpl*, CSSSelector::PseudoType>* nameToPseudoTypeMap()
{
    ...
    DEFINE_STATIC_LOCAL(AtomicString, requiresFullscreen, ("-webkit-requires-fullscreen", AtomicString::ConstructFromLiteral));
    ...
    if (!nameToPseudoType) {
        ...
        nameToPseudoType->set(requiresFullscreen.impl(), CSSSelector::PseudoRequiresFullscreen);
