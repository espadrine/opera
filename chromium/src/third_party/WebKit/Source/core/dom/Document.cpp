...
bool Document::setFocusedNode(PassRefPtr<Node> prpNewFocusedNode, FocusDirection direction)
{
    ...
    if (oldFocusedNode) {
        ...
        if (oldFocusedNode->isRootEditableElement())
            frame()->editor()->didEndEditing(oldFocusedNode.get());
    ...
    if (newFocusedNode && newFocusedNode->isFocusable()) {
        ...
        if (m_focusedNode->isRootEditableElement())
            frame()->editor()->didBeginEditing(m_focusedNode.get());
...
void Document::suspendMedia()
{
    HTMLMediaElement::documentSuspend(this);
}

void Document::resumeSuspendedMedia()
{
    HTMLMediaElement::documentResumeSuspended(this);
}

void Document::clearSuspendedMedia()
{
    HTMLMediaElement::documentClearSuspended(this);
}

bool Document::hasPlayingMedia()
{
    return HTMLMediaElement::documentHasPlaying(this);
}

bool Document::hasSuspendedMedia()
{
    return HTMLMediaElement::documentHasSuspended(this);
}
