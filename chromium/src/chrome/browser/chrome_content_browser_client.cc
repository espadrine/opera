...
#endif
  opium::TurboManager* turbo_manager =
      opium::TurboManagerFactory::GetForProfile(profile);
  web_prefs->media_blocking_enabled = turbo_manager->ShouldUseTurboForUrl(url);
}
