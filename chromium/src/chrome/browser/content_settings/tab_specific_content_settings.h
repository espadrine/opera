...
class TabSpecificContentSettings
 ...
 public:
  ...
  bool IsContentBlockedByTurbo(TurboContentSettingsType content_type) const;
  ...
  void OnTurboContentBlocked(TurboContentSettingsType type,
                             const std::string& resource_identifier);
  void OnBlockedTurboContentRemoved(TurboContentSettingsType type,
                                    const std::string& resource_identifier);
 ...
 private:
  ...
  // Number of blocked resources of each content type.
  int turbo_content_blocked_resources_[TURBO_CONTENT_SETTINGS_NUM_TYPES];
