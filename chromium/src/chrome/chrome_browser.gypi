  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/download/download_enhance_manager.cc',
        'browser/download/download_enhance_manager.h',
        ...
        'browser/policy/turbo_blacklist_manager.cc',
        'browser/policy/turbo_blacklist_manager.h',
        ...
        'browser/turbo/turbo_manager.cc',
        'browser/turbo/turbo_manager.h',
        'browser/turbo/turbo_manager_factory.cc',
        'browser/turbo/turbo_manager_factory.h',
        'browser/undo/undo_service.cc',
        'browser/undo/undo_service.h',
        'browser/undo/undo_service_factory.cc',
        'browser/undo/undo_service_factory.h',
      ...
      'conditions': [
        ['enable_torrent==1', {
          'sources': [
            '<(opium_common_directory)/common/torrent/torrent_api_opium.cc',
            '<(opium_common_directory)/common/torrent/torrent_api_opium.h',
            '<(opium_common_directory)/common/torrent/torrent_manager.cc',
            '<(opium_common_directory)/common/torrent/torrent_manager.h',
            '<(opium_common_directory)/common/torrent/torrent_types.h',
            '<(opium_common_directory)/common/chromium/chrome/torrent_enhancer.cc',
            '<(opium_common_directory)/common/chromium/chrome/torrent_enhancer.h',
            '<(opium_common_directory)/common/chromium/chrome/url_request_magnet_link_job.cc',
            '<(opium_common_directory)/common/chromium/chrome/url_request_magnet_link_job.h',
          ],
          'conditions': [
            ['OS=="win"', {
              'copies': [
                {
                  ...
                  'files': [
                    '<(opium_common_directory)/common/bin/windows/TorrentAPIOP.dll',
                  ],
                },
              ],
            }],
              ...
              'copies': [
                {
                  'destination': '<(PRODUCT_DIR)',
                  'files': [
                    '<(opium_common_directory)/common/bin/mac/TorrentAPIOP.dylib',
                    '<(opium_common_directory)/common/bin/mac/libboost_system.dylib',
                    '<(opium_common_directory)/common/bin/mac/libboost_date_time.dylib',
                  ],
                },
              ]
            }],
