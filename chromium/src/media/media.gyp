...

{
  'variables': {
    ...
    'conditions': [
      ...
      # ALSA usage.
      ['(OS=="linux" or OS=="freebsd" or OS=="solaris") and linux_embedded==0', {
        'use_alsa%': 1,
      }, {
        'use_alsa%': 0,
      }],
  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['opera_tvsdk == 1 and media_use_ffmpeg == 0', {
          'sources': [
            'base/media_stub.cc',
          ],
        }],
      ...
      'targets': [
        ...
        },
        {
          ...
          'sources': [
            ...
            'base/android/surface_texture_support.cc',
            'base/android/surface_texture_support.h',
