...
void MediaSourcePlayer::SetVideoSurfaceHolder(jobject surface_holder) {
  // This function is used for fullscreen video in Opera on 2.3+ devices.
  // Currently the HTML5 Media Source API is disabled on Android.
  DCHECK(false) << "Implement Android 2.3+ support or selectively disable"
    << " the HTML5 Media Source API depending on OS version.";
}
