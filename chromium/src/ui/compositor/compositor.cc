...
void Compositor::NonEmptyTreeActivated() {
}
...
void Compositor::DidCompleteScale() {
}

void Compositor::DidPinchGesture(float scale, const gfx::Point&) {
}

void Compositor::MaxScrollUpdated(const gfx::Vector2d& max_scroll) {
}

void Compositor::PendingTreeActivated(const gfx::Vector2d& scrollTotal) {
}
