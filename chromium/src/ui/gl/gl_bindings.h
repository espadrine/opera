...
#if defined(USE_X11) || defined(LINUX_EMBEDDED)
...
#include "gl_bindings_autogen_egl.h"
#elif defined(OS_ANDROID) || defined(LINUX_EMBEDDED)
#include "gl_bindings_autogen_egl.h"
#endif
...
#if defined(OS_WIN) || defined(USE_X11) || defined(OS_ANDROID) || defined(USE_OZONE) || defined(LINUX_EMBEDDED)
