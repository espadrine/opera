  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['use_aura==0 and toolkit_views==0 and linux_embedded==0', {
          'sources/': [
        ...
        ['OS=="win"', {
          ...
          'conditions': [
            ['use_aura==0 and linux_embedded==0', {
              'sources!': [
                'base/view_prop.cc',
                'base/view_prop.h',
              ],
        ...
        ['toolkit_views==0 and opera_tvsdk==0', {
          'sources!': [
            'base/events/event.cc',
            'base/events/event.h',
            'base/events/event_dispatcher.cc',
