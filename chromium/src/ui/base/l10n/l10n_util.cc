...
#if defined(OS_LINUX) && defined(USE_GLIB)
#include <glib.h>
#endif
...
std::string GetApplicationLocale(const std::string& pref_locale) {
  ...
  // TODO(rogerj@opera.com): Restore the old custom code[1] mentioned in the
  // OS_LINUX section below and use that here.
  // [1] http://src.chromium.org/viewvc/chrome/trunk/src/ui/base/l10n/l10n_util.cc?r1=64234&r2=64524
