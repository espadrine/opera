...
void ResourceBundle::LoadCommonResources() {
  AddDataPackFromPath(GetResourcesPakFilePath(@ COMMON_RESOURCES_PREFIX, nil),
                      SCALE_FACTOR_NONE);
  AddDataPackFromPath(
      GetResourcesPakFilePath(@ COMMON_RESOURCES_PREFIX "_100_percent", nil),
      SCALE_FACTOR_100P);
  ...
  if (IsScaleFactorSupported(SCALE_FACTOR_200P)) {
    AddDataPackFromPath(
        GetResourcesPakFilePath(@ COMMON_RESOURCES_PREFIX "_200_percent", nil),
        SCALE_FACTOR_200P);
