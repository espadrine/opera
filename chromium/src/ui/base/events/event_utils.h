...
// Creates a copy of a native event.
UI_EXPORT base::NativeEvent CopyNativeEvent(const base::NativeEvent& event);

// Deletes a copy of a native event as created by CopyNativeEvent.
UI_EXPORT void DeleteNativeEvent(const base::NativeEvent& event);
#endif
