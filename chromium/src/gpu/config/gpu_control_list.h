 ...
 private:
  ...
  class GPU_EXPORT GpuControlListEntry
   ...
   public:
    ...
    // Returns a list of Chromium, Webkit and Opera bugs applicable to this entry
    const std::vector<int>& cr_bugs() const { return cr_bugs_; }
    const std::vector<int>& webkit_bugs() const { return webkit_bugs_; }
    const std::vector<std::string>& opera_bugs() const { return opera_bugs_; }
   ...
   private:
    ...
    std::vector<std::string> opera_bugs_;
